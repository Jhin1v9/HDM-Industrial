...
const en = {
  ...
  home: {
    ...
    comoSub: "Three steps. No commitment, with a response within business hours.",
    como1t: "Tell us what you need",
    como1d: "Profile, process, deadline and location. Configure your request in under a minute.",
    como2t: "HDM checks availability",
    como2d: "We verify PRL training, certifications and crews available in your area.",
    como3t: "Receive verified profiles",
    como3d: "We confirm real availability before you commit. No surprises.",
    faqTitle: "Frequently asked questions",
    faq1q: "How fast do I get a response?",
    faq1a: "HDM reviews every request within business hours and confirms real availability before you commit to anything.",
    faq2q: "Does the request confirm availability?",
    faq2a: "No. The request is without commitment: it lets HDM verify crews and reply with real options.",
    faq3q: "Which profiles can I request?",
    faq3a: "TIG, MIG/MAG and stick welders, boilermakers, fitters, electricians, electromechanics, industrial mechanics, labourers and supervisors.",
...
export const enCareers = {
  careers: {
    ...
    attachLabel: "CV (PDF, Word or image)",
    attachCta: "Select file",
    attachSelected: "File selected",
    attachPrivacy: "Your CV is treated privately and used only to assess your application.",
    attachEmailLabel: "CV",
    submitSuccess: "CV sent — thank you. HDM will review your profile and contact you if there is a match.",
