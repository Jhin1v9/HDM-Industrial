...
**Resolvido (14/09):** deixar o repo **público**
(`gh repo edit Jhin1v9/HDM-Industrial --visibility public --accept-visibility-change-consequences`)
destravou o deploy por push — build Ready em ~20s. Push→Vercel volta a ser o
fluxo normal.

**Workaround usado enquanto estava bloqueado (funciona, 14/09):** deploy do
export estático pela CLI autenticada como dono do time:
